 ...
 * @see com.kinth.framework.core.spring.ext.web.WebLogbackConfigurer WebLogbackConfigurer
 * @see com.kinth.framework.core.spring.ext.web.LogbackConfigListener LogbackConfigListener
 * @see com.kinth.framework.core.spring.ext.web.LogbackConfigServlet LogbackConfigServlet
 * @since 0.1
 */
public class LogbackConfigurer {
     ...
     * 
     * @param key
     *            system property key to use, as expected in Logback configuration (for example: "demo.root", used as
