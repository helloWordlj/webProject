...
public class SystemConfig {
	 ...
	 * 业务规则集合
	 */
	// / public static Map<String, Businesses> businessesMap = new
	// HashMap<String, Businesses>();
	...
	public static void loadSystemConfig() {
		if (isExeced.compareAndSet(false, true)) {
			PropertiesUtils propertiesUtils = new PropertiesUtils(
					"classpath:" + SystemConstants.FILE_SEPARATOR + SystemConstants.YXW_FRAMEWORK_CONFIG,
					"classpath:" + SystemConstants.FILE_SEPARATOR + SystemConstants.INTERFACE_CONFIG);
