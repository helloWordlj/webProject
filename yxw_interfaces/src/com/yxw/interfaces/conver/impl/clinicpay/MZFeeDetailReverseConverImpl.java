...
/**
 * @Package: com.yxw.interfaces.conver.impl.clinicpay
 * @ClassName: MAFeeDetailReverseConverImpl
 * @Statement: <p></p>
 * @JDK version used: 
 * @Author: 申午武
 ...
 * @Version: 1.0
 */
public class MZFeeDetailReverseConverImpl extends BaseConver implements Conver<String, List<MZFeeDetail>> {

	@Override
	public List<MZFeeDetail> doConver(String t) {
		return null;
	}
