...
/**
 * @Package: com.yxw.interfaces.conver.impl.clinicpay
 * @ClassName: MZFeeReverseConverImpl
 * @Statement: <p></p>
 * @JDK version used: 
 * @Author: 申午武
 ...
 * @Version: 1.0
 */
public class MZFeeReverseConverImpl extends BaseConver implements Conver<String, List<MZFee>> {

	@Override
	public List<MZFee> doConver(String t) {
		return null;
	}
