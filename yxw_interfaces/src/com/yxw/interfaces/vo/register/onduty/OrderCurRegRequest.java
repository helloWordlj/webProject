 ...
 * @declare
 * 广州市第一人民医院已使用
 * reservedFieldThree:用于区分就诊类型
 * reservedFieldFour:用于区分患者类型
 * @author 申午武
 * @version 1.0
 * @since 2015年5月15日
 */

public class OrderCurRegRequest extends Reserve implements Serializable {
	...
	public OrderCurRegRequest(String psOrdNum, String branchCode, String deptCode, String doctorCode, String scheduleDate, String timeFlag,
