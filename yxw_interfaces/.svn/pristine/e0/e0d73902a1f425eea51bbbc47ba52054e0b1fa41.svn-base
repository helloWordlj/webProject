...
/**
 * @Package: com.yxw.interfaces.conver.impl.clinicpay
 * @ClassName: MZFeeDetailConverImpl
 * @Statement: <p></p>
 * @JDK version used: 
 * @Author: 申午武
 ...
 * @Version: 1.0
 */
public class MZFeeDetailConverImpl extends BaseConver implements Conver<MZFeeDetailRequest, String> {

	@Override
	public String doConver(MZFeeDetailRequest t) {
		return null;
	}
