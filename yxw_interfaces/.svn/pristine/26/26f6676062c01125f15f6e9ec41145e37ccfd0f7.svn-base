...
public class Examine extends Reserve implements Serializable {
	...
	public Examine(String checkId, String checkName, String checkType, String checkTypeName, String deptName, String doctorName, String checkTime,
			String orderDoctor, String orderDoctorCode, String orderDept, String reportTime, String fileAddress) {
		super();
	...
	/**
	 * @param checkTypeName the checkTypeName to set
	 */
	...
	/**
	 * @param orderDoctorCode the orderDoctorCode to set
	 */
	...
	/**
	 * @param orderDept the orderDept to set
	 */
