...
public class UnpaidRegRecord extends Reserve implements Serializable {
	...
	public UnpaidRegRecord(String branchCode, String hisOrdNum,
			String deptCode, String deptName, String doctorCode,
			String doctorName, String regType, String bookDate, 
			String timeFlag, String beginTime, String endTime, 
			String regAgency, String realRegFee, String realTreatFee) {
		super();
